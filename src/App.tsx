...
const COSTS = {
  ...
  const generateStory = async (overridePrompt?: string, overrideStyle?: VisualStyle, type: 'quote' | 'narrative' | 'analyze' = 'narrative') => {
    ...
    try {
      ...
      else if (activeStyle === "HOLOGRAPHIC SOUL") styleDetail = "Masterpiece, hyper-detailed scene. Holographic style: semi-transparent glowing light projections, subtle chromatic aberration, glitch scanlines, luminous neon/cyan/magenta hues, futuristic sci-fi hologram aesthetic, volumetric lighting in a dark ambient setting.";
